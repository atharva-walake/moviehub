    ...
    <form>
      <Grid container spacing={6}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <DateSelect
            date={props.getFieldValue("startTime")}
            dateFormat="HH:mm"
            showTimeSelectOnly
            timePicker
            required={true}
            ...
            inputProps={{
              required: true,
              helperText: `${startTimeStr}` + +t("_in_current_user_timezone_"),
              placeholder: t("_start_time_")
            }}
            onChange={value => {
        ...
        <Grid item xs={12} sm={6} md={3}>
          <DateSelect
            date={props.getFieldValue("endTime")}
            dateFormat="HH:mm "
            timeFormat="HH:mm"
            showTimeSelectOnly
            timePicker
            ...
            inputProps={{
              required: true,
              helperText: `${endTimeStr}` + t("_in_current_user_timezone_"),
              placeholder: t("_end_time_")
            }}
            onChange={value => {
